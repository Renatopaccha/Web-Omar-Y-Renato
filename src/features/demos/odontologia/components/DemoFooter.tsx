            ...
            <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <nav className="flex flex-col gap-3">
                            <Link to={DEMO_BASE} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                                Inicio
                            </Link>
                            <Link to={`${DEMO_BASE}/servicios`} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                                Servicios
                            </Link>
                            <Link to={`${DEMO_BASE}/credenciales`} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                                Credenciales
                            </Link>
                            <Link to={`${DEMO_BASE}/reservar`} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                                Reservar cita
                            </Link>
                        </nav>
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-6">
                        <Link to={`${DEMO_BASE}/privacidad`} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                            Privacidad
                        </Link>
                        <span className="text-xs text-muted-foreground">
                            Plantilla demo · ClinicaWeb
                        </span>
                    </div>
                </div>
            </div>
