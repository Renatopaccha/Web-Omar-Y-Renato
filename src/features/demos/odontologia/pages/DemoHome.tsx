...
const heroImages = {
    clinic:
        'https://images.unsplash.com/photo-1762625570087-6d98fca29531?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBkZW50YWwlMjBjbGluaWMlMjBvZmZpY2UlMjBpbnRlcmlvcnxlbnwxfHx8fDE3NzEzNDA1Mzl8MA&ixlib=rb-4.1.0&q=80&w=1080',
    doctor:
        'https://images.unsplash.com/photo-1754715203698-70c7ad3a879d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBkZW50aXN0JTIwcG9ydHJhaXQlMjB3aGl0ZSUyMGNvYXR8ZW58MXx8fHwxNzcxMzU4MDMwfDA&ixlib=rb-4.1.0&q=80&w=1080',
    equipment:
        'https://images.unsplash.com/photo-1642844819197-5f5f21b89ff8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZW50YWwlMjBjbGluaWMlMjBlcXVpcG1lbnQlMjBtb2Rlcm58ZW58MXx8fHwxNzcxMzAxNjA2fDA&ixlib=rb-4.1.0&q=80&w=1080',
};
...
const credentials = [
    { title: 'DDS, Odontología', institution: 'Universidad Central del Ecuador', icon: Award },
    { title: 'MSc, Rehabilitación Oral', institution: 'Universidad San Francisco de Quito', icon: Award },
    { title: 'Certificación en Estética Dental', institution: 'Asociación Latinoamericana de Estética', icon: Sparkles },
    { title: '+10 años de experiencia', institution: 'Práctica privada y clínica', icon: TrendingUp },
];
    ...
    return (
        <div className="w-full">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-4 mb-12">
                                ...
                                <Link to={`${DEMO_BASE}/credenciales`}>
            ...
            <section className="bg-card border-y border-border">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <TrustBadge icon={Award} title="+10 años de experiencia" subtitle="Práctica clínica comprobada" />
                        <TrustBadge icon={Shield} title="Atención basada en evidencia" subtitle="Protocolos internacionales" />
                        <TrustBadge icon={Sparkles} title="Equipo moderno" subtitle="Tecnología actualizada" variant="gold" />
                        <TrustBadge icon={Globe} title="ES / EN / DE / FR" subtitle="Atención multiidioma" />
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 lg:py-32 bg-background">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-5xl font-semibold text-foreground mb-4">Credenciales destacadas</h2>
            ...
            <section className="py-20 lg:py-32 bg-secondary/30">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-5xl font-semibold text-foreground mb-4">Servicios principales</h2>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            <section className="py-20 lg:py-32 bg-background">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl lg:text-5xl font-semibold text-foreground mb-6">Por qué elegirnos</h2>
                            <p className="text-lg text-muted-foreground mb-8">Compromiso con tu salud y bienestar dental</p>
            ...
            <section className="py-20 lg:py-32 bg-card border-y border-border">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-5xl font-semibold text-foreground mb-4">Precios orientativos</h2>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="bg-background rounded-2xl border border-border overflow-hidden">
                            {pricingItems.map((item, index) => (
                                <div
                                    key={index}
                                    className={`flex items-center justify-between p-6 ${index !== pricingItems.length - 1 ? 'border-b border-border' : ''
                                        }`}
                                >
            ...
            <section className="py-20 bg-background">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <StatCard value="10+" label="Años de experiencia" icon={Award} />
                        <StatCard value="1,200+" label="Pacientes atendidos" icon={Users} />
                        <StatCard value="98%" label="Satisfacción" icon={TrendingUp} />
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 lg:py-32 bg-gradient-to-br from-primary/5 to-accent/5">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl lg:text-5xl font-semibold text-foreground mb-6">Ubicación y horarios</h2>
                        ...
                        <div className="bg-card rounded-3xl p-12 border border-border shadow-xl">
                            <h3 className="text-2xl font-semibold text-foreground mb-4">¿Listo para agendar?</h3>
                            <p className="text-muted-foreground mb-8">
                                Reserva tu consulta inicial en menos de 2 minutos. Sin compromisos.
                            </p>

                            <div className="space-y-4">
                                <Link to={`${DEMO_BASE}/reservar`} className="block">
                                    <Button size="lg" className="w-full rounded-full">
                                        <Calendar className="w-5 h-5 mr-2" />
                                        Reservar cita ahora
                                    </Button>
                                </Link>
                                <Link to={`${DEMO_BASE}/contacto`} className="block">
