...
const academicDegrees = [
  {
    ...
    year: '2014',
    description:
      'Formación integral en odontología general, cirugía oral y diagnóstico clínico.',
  },
  {
    ...
    year: '2017',
    description:
      'Especialización avanzada en rehabilitación funcional y estética dental compleja.',
  },
  {
    ...
    year: '2018',
    description:
      'Enfoque en diseño de sonrisa, carillas y procedimientos estéticos mínimamente invasivos.',
  },
];
...
export default function OdontologiaCredentials() {
  return (
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl">
              Formación académica, experiencia clínica y certificaciones que respaldan un servicio
              de excelencia
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              >
                ...
                <div className="space-y-4 text-foreground leading-relaxed">
                  <p>
                    Soy odontóloga con más de 10 años de experiencia en odontología estética y
                    rehabilitación oral. Mi enfoque combina precisión técnica con una comunicación
                    clara y empática, buscando que cada paciente comprenda su tratamiento y se
                    sienta seguro en cada etapa.
                  </p>
                  <p>
                    Creo en la odontología basada en evidencia y en la formación continua. Me
                    especializo en tratamientos que devuelven función y estética dental con técnicas
                    mínimamente invasivas, priorizando la conservación de tejido dental natural.
                  </p>
                  <p>
                    Mi práctica se caracteriza por protocolos de bioseguridad rigurosos,
                    equipamiento moderno y un ambiente cálido donde la comodidad del paciente es
                    prioritaria.
                  </p>
                </div>
              </motion.div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="bg-card rounded-3xl border border-border shadow-xl p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Agenda tu consulta inicial y descubre cómo podemos ayudarte a lograr la sonrisa que
              deseas
            </p>
