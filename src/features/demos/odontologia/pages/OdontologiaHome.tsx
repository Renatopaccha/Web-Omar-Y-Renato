...
const services = [
  {
    ...
    description:
      'Limpieza dental profesional, remoción de sarro y pulido. Prevención y cuidado de encías.',
    duration: '45-60 min',
    price: '$45',
  },
  {
    ...
    description:
      'Tratamiento de blanqueamiento profesional con tecnología LED. Resultados visibles desde la primera sesión.',
    duration: '60-90 min',
    price: '$280',
  },
  {
    ...
    description:
      'Carillas de porcelana o composite para mejorar forma, color y alineación. Resultados naturales y duraderos.',
  ...
  },
  {
    ...
    description:
      'Restauración completa de función y estética dental mediante implantes, coronas y prótesis.',
  ...
  },
  {
    title: 'Endodoncia',
    description:
      'Tratamiento de conducto radicular con técnicas modernas y anestesia confortable.',
    duration: '90 min',
    price: '$320',
  },
  {
    ...
    description:
      'Diseño de sonrisa personalizado combinando múltiples tratamientos para resultados armónicos.',
...
const testimonials = [
  {
    content:
      'Excelente atención. La Dra. Romero explica cada paso del tratamiento con mucha claridad. Me sentí muy cómoda durante todo el proceso.',
    author: 'M.S.',
    location: 'Cuenca',
  },
  {
    content:
      'El consultorio es muy moderno y limpio. Los resultados del blanqueamiento superaron mis expectativas. Totalmente recomendado.',
    author: 'C.T.',
    location: 'Cuenca',
  },
  {
    content:
      'Profesionalismo y calidez humana. Llevo 3 años como paciente y siempre recibo el mismo nivel de atención excepcional.',
    author: 'J.P.',
    location: 'Azogues',
  },
];
    ...
    <div className="w-full">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
                Tratamientos personalizados, comunicación clara y una experiencia moderna de
                consulta. Reserva en minutos.
              </p>

              <p className="text-sm text-muted-foreground mb-8 italic">
                <span className="inline-block px-2 py-0.5 bg-secondary rounded text-xs mr-2">
                  Demo multiidioma
                </span>
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                ...
                <Link to="/demos/odontologia/credenciales">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-primary mt-0.5">
                      Odontología Estética y Rehabilitación
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 lg:py-32 bg-secondary/30">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
            ...
            {services.map((service, index) => (
              ...
              >
                <ServiceCard
                  ...
                  price={service.price}
                  link="/demos/odontologia/servicios"
                />
              </motion.div>
            ))}
          </div>
          ...
          <div className="text-center">
            <Link to="/demos/odontologia/servicios">
              <Button size="lg" className="rounded-full">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-sm text-muted-foreground italic">
              Los precios son referenciales. El costo final depende de la evaluación clínica
              personalizada.
            </p>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      <br />
                      Edificio Médico Santa Ana, Piso 3, Consultorio 302
                      <br />
                      Cuenca, Ecuador
                    </p>
                  </div>
            ...
            <div className="bg-card rounded-3xl p-12 border border-border shadow-xl">
              ...
              <div className="space-y-4">
                <Link to="/demos/odontologia/reservar" className="block">
                  <Button size="lg" className="w-full rounded-full">
                    <Calendar className="w-5 h-5 mr-2" />
                    Reservar cita ahora
                  </Button>
                </Link>
                <Link to="/demos/odontologia/contacto" className="block">
